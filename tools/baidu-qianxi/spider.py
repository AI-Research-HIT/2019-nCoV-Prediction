...
def conserve(html, time, name):
    ...
    province = []
    for i in html['list']:
        city.append(i['city_name'])
        province.append(i['province_name'])
        value.append(i['value'])
    res = {'城市':city, '省份':province, '比例':value}
...
if __name__ == '__main__':
    ...
    time = list(range(20200110, 20200132)) + list(range(20200201, 20200208))
    if not os.path.exists(move_type):
        os.mkdir(move_type)
    os.chdir(move_type)
    exist = os.listdir()
