        ...
        <el-col :span="24" class="header">
            ...
            <el-col :span="8" class="userinfo">
                <span class="userinfo-inner">
                    <img src="/static/assets/image/AI-Research-HIT.png" />
                    <h3 class="title">哈尔滨工业大学人工智能研究院</h3>
                </span>
            </el-col>
                    ...
                    <el-row>
                        <el-col :span="5" :offset="7">
                            <img
                                ...
                                src="/static/assets/image/AI-Research-HIT.png"
                            />
                        </el-col>
                        <el-col :span="5">
                            <img
                                style="width: 65%;height: 65%"
                                src="/static/assets/image/china-mobile.png"
                            />
                        </el-col>
                    </el-row>
