		...
		<!--工具条-->
            <el-form ref="form" :model="form" class="history">
                <el-form-item label="选择地区: ">
                  <el-row>
                    <el-col>
                      <el-radio v-model="areaRadio" label="1" @change="onAreaRadioChange">根据省份或者城市数据计算，只选择省份将计算该省疫情预测，选择省份下的城市将计算城市疫情预测</el-radio>
                    </el-col>
                    <el-col :span="5">
                  ...
                  <el-row>
                    <el-col>
                      <el-radio v-model="areaRadio" @change="onAreaRadioChange" label="2">选择其他国家或者地区数据进行计算</el-radio>
                    </el-col>
                    <el-col :span="5">
                      <el-select v-model="form.country" @change="onCountryChange" placeholder="国家和地区">
                          <el-option
        ...
        <el-form-item label="人员聚集度">
          <el-row>
            <el-col>
                ...
                <p class="text">人员聚集度列表格式为:0-10.0;3-4.0;8-1.0, 表示从第0天开始人员聚集度为10.0, 第3天开始人员聚集度为4.0, 第8天开始人员聚集度为1.0, 其中天数必须为整数</p>
            </el-col>
          <el-col :span="5">
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        countryOptions: [{value:"以色列", Label:"以色列"},  {value:"伊拉克", Label:"伊拉克"},  {value:"伊朗", Label:"伊朗"},  {value:"俄罗斯", Label:"俄罗斯"},  {value:"克罗地亚", Label:"克罗地亚"},  {value:"加拿大", Label:"加拿大"},  {value:"印度", Label:"印度"},  {value:"台湾", Label:"台湾"},  {value:"埃及", Label:"埃及"},  {value:"奥地利", Label:"奥地利"},  {value:"尼泊尔", Label:"尼泊尔"},  {value:"巴林", Label:"巴林"},  {value:"德国", Label:"德国"},  {value:"意大利", Label:"意大利"},  {value:"斯里兰卡", Label:"斯里兰卡"},  {value:"新加坡", Label:"新加坡"},  {value:"日本", Label:"日本"},  {value:"柬埔寨", Label:"柬埔寨"},  {value:"比利时", Label:"比利时"},  {value:"法国", Label:"法国"},  {value:"泰国", Label:"泰国"},  {value:"澳大利亚", Label:"澳大利亚"},  {value:"澳门", Label:"澳门"},  {value:"瑞典", Label:"瑞典"},  {value:"瑞士", Label:"瑞士"},  {value:"科威特", Label:"科威特"},  {value:"美国", Label:"美国"},  {value:"芬兰", Label:"芬兰"},  {value:"英国", Label:"英国"},  {value:"菲律宾", Label:"菲律宾"},  {value:"西班牙", Label:"西班牙"},  {value:"越南", Label:"越南"},  {value:"钻石公主号邮轮", Label:"钻石公主号邮轮"},  {value:"阿富汗", Label:"阿富汗"},  {value:"阿尔及利亚", Label:"阿尔及利亚"},  {value:"阿曼", Label:"阿曼"},  {value:"阿联酋", Label:"阿联酋"},  {value:"韩国", Label:"韩国"},  {value:"香港", Label:"香港"},  {value:"马来西亚", Label:"马来西亚"},  {value:"黎巴嫩", Label:"黎巴嫩"}],
        areaRadio: '1'
      }
    }
  }
